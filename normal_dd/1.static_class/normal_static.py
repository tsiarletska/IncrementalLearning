...
while len(stream_values) < TOTAL_ITERATIONS:
    ...
    if choice == 1:
        segment = random_state.normal(0.6258, 0.0470, Ti)  # dist_a
        color = "tab:blue"
    elif choice == 2:
        segment = random_state.normal(0.3745, 0.0204, Ti)  # dist_b
        color = "tab:orange"
    elif choice == 3:
        segment = random_state.normal(0.5760, 0.0288, Ti)  # dist_c
        color = "tab:green"
    elif choice == 4:
        segment = random_state.normal(0.5561, 0.0605, Ti)  # dist_d
        color = "tab:red"
    elif choice == 5:
        segment = random_state.normal(0.5985, 0.0654, Ti)  # dist_e
        color = "tab:purple"

    stream_values.extend(segment)
...
stream_labels = (stream_values > 0.50).astype(int)
